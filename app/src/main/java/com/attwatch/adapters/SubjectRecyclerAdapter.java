...
import com.attwatch.activities.SubjectLog;
        ...
        if(t!=0){
            if(p>99) {
                if(j>0){
                    ...
                    holder.detail.setText("Do not miss a single lecture!");
                }
            } else {
                int x = (int) (((100 / p) * i) - i);
                ...
                if (x - j < 0) {
                    ...
                    holder.detail.setText("Flexible leaves available : " + String.valueOf(x - j));
                }
            }
